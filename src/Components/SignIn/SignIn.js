...
const SignIn = () => {
    ...
    return (
        <div>
            <Card body className="mx-auto my-5 p-3" style={{ maxWidth: "400px" }}>
                ...
                <Button variant="outline-dark" onClick={handleSignInUsingGoogle} className="w-100 pt-2">Continue with Google</Button>
